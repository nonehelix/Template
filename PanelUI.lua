...
function Panel:CreateDropdownBase(button, itemCount)
	...
	table.insert(self.State.AccentObjects.DropdownStrokes, createStroke(dropdown, Theme.Stroke, 1, 0.2))
	...
	if useScroll then
		...
		AddCleanupItem(self.Runtime, layout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(updateScrollCanvas))
